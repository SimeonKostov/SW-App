...
const SWFilm=({name, terrain, gravity, climate, population })=>{
    return(
        <div className='tc dib w-20 h5 pa2 pt4 mr2 mb2 br4-l grow bg-navy' style={{border: '2px solid #f1c40f'}}>
